...
#include "UE5_FallGuys/MovingPlatform.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMovingPlatform() {}
// Cross Module References
	UE5_FALLGUYS_API UClass* Z_Construct_UClass_AMovingPlatform_NoRegister();
	UE5_FALLGUYS_API UClass* Z_Construct_UClass_AMovingPlatform();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_UE5_FallGuys();
...
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMovingPlatform_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_UE5_FallGuys,
	};
#if WITH_METADATA
	...
	template<> UE5_FALLGUYS_API UClass* StaticClass<AMovingPlatform>()
	{
		return AMovingPlatform::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMovingPlatform);
	struct Z_CompiledInDeferFile_FID_UE5_FallGuys_Source_UE5_FallGuys_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_FallGuys_Source_UE5_FallGuys_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 2258606053U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_FallGuys_Source_UE5_FallGuys_MovingPlatform_h_2088706299(TEXT("/Script/UE5_FallGuys"),
		Z_CompiledInDeferFile_FID_UE5_FallGuys_Source_UE5_FallGuys_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE5_FallGuys_Source_UE5_FallGuys_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
